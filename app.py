...
from game.logic import (
    ...
    resolve_battle,
    state_for_client,
    # add choose_reward, handle_gear_choice, shop_action if your game.html calls them
)
...
@app.get("/")
def index():
    return render_template("game.html")  # or create a simple landing if you prefer
